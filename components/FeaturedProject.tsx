  ...
  return (
    <section id="featured" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 className="text-2xl font-bold text-text-main mb-6 fade-up">Featured Project</h2>

        <div
          className="fade-up rounded-xl border border-gray-100 shadow-sm bg-primary-light overflow-hidden"
        ...
        >
          <div className="p-6 lg:p-8">
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <div className="text-xs font-semibold text-primary uppercase tracking-wide mb-0.5">
                  EU Horizon Europe · PVT4EU (CETP-2022-00403)
                </div>
            ...
            <div className="grid sm:grid-cols-3 gap-3 mb-5 text-sm">
              <div>
                <span className="text-xs text-text-secondary uppercase tracking-wide font-semibold">Role</span>
                <div className="text-text-main font-medium">Environmental Engineer (Intern)</div>
              </div>
              <div>
                <span className="text-xs text-text-secondary uppercase tracking-wide font-semibold">Organisation</span>
                <div className="text-text-main font-medium">MG Sustainable Engineering AB, Uppsala</div>
              </div>
              <div>
                <span className="text-xs text-text-secondary uppercase tracking-wide font-semibold">Period</span>
                <div className="text-text-main font-medium">February – June 2025</div>
              </div>
            </div>
            ...
            {/* Key results */}
            <div className="mb-5">
              <div className="text-xs font-semibold text-text-secondary uppercase tracking-wide mb-2">Key results</div>
